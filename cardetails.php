...
<?php 
  ...
  <div class="cd">
    <div class="main">
        <div class="navbar">
            <div class="icon">
                <h2 class="logo">TaxiTrackr</h2>
            </div>
            <div class="menu">
               
                <ul>
                    <li><a class= "li1" href="#">HOME</a></li>
                    <li><a class= "li1" href="aboutus2.html">ABOUT</a></li>
                    
                    <li><a class= "li1" href="contactus2.html">CONTACT</a></li>
                    <li><a class= "li1" href="feedback/Feedbacks.php">FEEDBACK</a></li>
      ...
      <div><h1 class="overview">AVAILABLE TAXIS NOW</h1>
    ...
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>Taxi Type : <a><?php echo $result['FUEL_TYPE']?></a> </h2>
            <h2>Available Seats : <a><?php echo $result['CAPACITY']?></a> </h2>
            <h2>Rent : <a>₹<?php echo $result['PRICE']?>/-</a></h2>
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking.php?id=<?php echo $res;?>">Book Cab</a></button>
        </div>
    </div></form></li>
    <?php
        }
